...
function setup() {
  ...
  rectangulo1=new Block(640,150,30,40);
  rectangulo2=new Block(670,150,30,40);
  rectangulo3=new Block(700,150,30,40);
  rectangulo4=new Block(730,150,30,40);
  rectangulo5=new Block(760,150,30,40);
  //piramide 2 Segundo nivel
  rectangulo6=new Block(670,100,30,40);
  rectangulo7=new Block(700,100,30,40);
  rectangulo8=new Block(730,100,30,40);
  //piramide 2 Tercer nivel
  rectangulo9=new Block(700,50,30,40);
